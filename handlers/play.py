...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "parliamentasistan"
    usar = user
    wew = usar.id
    try:
    ...
    if audio:
        ...
        [
            [
                InlineKeyboardButton("🚀 sᴀʜɪ̇ʙ", url=f"https://t.me/deronizimmmmm"),
                InlineKeyboardButton("📣 Kanal", url=f"https://t.me/sohbetimparliament"),
            ],[
